...
import com.lovable_clone.lovable_clone.error.BadRequestException;
import com.lovable_clone.lovable_clone.mapper.UserMapper;
import com.lovable_clone.lovable_clone.repository.UserRepository;
import com.lovable_clone.lovable_clone.service.AuthService;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponse signup(SignupRequest request) {
        userRepository.findByUsername(request.username()).ifPresent(user -> {
            throw new BadRequestException("User already exits with username: "+ request.username());
        });
